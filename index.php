...
<script src="js/sponsor.js"></script>
  <script type="text/javascript">
      ...
      var bannerPics = ['images/banner1.jpg','images/banner2.jpg', 'images/banner3.jpg','images/banner5.jpg'];
      var images = randomfromarray(bannerPics);
      var selectBanner = document.querySelector('.banner');
      // $('.banner').css({'background-image': 'url(' + images + ')'});
      // };
      var style = 'url(' + images + ')';
      selectBanner.style.backgroundImage = style;
    };
      randomBanner();
  </script>
