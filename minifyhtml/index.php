  ...
  <div id='bannerplace' class='row'>
    <div class='col-sm-12 banner'>
      <div data-bind="if: documentReady, visible: show" class='center-fly'>
        <!-- <span class="font-roboto-light"> That the</span><span> Forgotten</span><span class="font-roboto-light"> Be</span><span> Found </span> -->
        <h3>New Project !</h3>
        <h2 style="margin-top:0;"><span class="font-roboto-light">Children’s Home and Learning Center</span><a href='https://mystory.lifesongfororphans.org/stories/childrens-home-learning-center/'><button type="button" class="btn btn-primary font-roboto-light btn-main-coh" style='background-color:#DC7E0F; margin-top:10px;'>Learn More</button></a></span></h2>
      </div>
