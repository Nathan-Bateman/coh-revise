...
?> <!doctype html><html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><meta name="viewport" content="width=device-width,height=device-height,initial-scale=1,maximum-scale=1,user-scalable=no"><meta http-equiv="X-UA-Compatible" content="IE=EDGE"><!-- Latest compiled and minified CSS --><link rel="shortcut icon" href="images/favicon.ico" type="image/x-icon"><link rel="stylesheet" type="text/css" href="css/final.min.css"><link href="http://fonts.googleapis.com/css?family=Roboto:300,400,700" rel="stylesheet" type="text/css"><title>About</title></head> <?php
   // generate a new token for the $_SESSION superglobal and put them in a hidden field
  $newToken = generateFormToken('form1');  
?> <body id="#body"><!--container div required by bootstrap--><div class="sitewrapper"><div id="container" class="container-fluid"><nav id="drawer" class="comeout"></nav><div class="header-wrapper"><div id="COH" class="row"><div class="col-sm-12"><div class="col-sm-6 padding-right-off pull-left"><h3 class="text-left cohfont header-full"><a href="index.php">Construction of Hope</a></h3><h3 class="text-left cohfont-abbr header-abbr">COH</h3></div><!--end of 1st col 6 div--><div id="hammy" class="col-sm-2 pull-right"><a id="menu" class="hammy glyphicon glyphicon-menu-hamburger pull-right"></a></div><div id="big-menu" class="col-sm-6 pull-right"><ul class="main-menu-big"></ul></div><!--end of 2nd col 6 div--></div><!--end of col 12 div--></div><!--end of 1st row--><div id="IPWITH" class="row"><div class="col-sm-12"><div class="col-sm-2 padding-right-off pull-left upsome"><h6 class="text-right ipwith font-roboto-light-heading">IN PARTNERSHIP WITH</h6></div><div class="col-sm-10 pull-left padding-left-off upsome"><img src="images/lifesongSharp.png" class="pull-left img-responsive"></div></div><!--end col 12 div--></div><!--end 2nd row--></div><!-- End of header wrapper --><!--end 2nd row--><div id="bannerplace" class="row"><div class="col-sm-12 banner"><div data-bind="if: documentReady, visible: show" class="center-fly-other"><h2><span class="font-roboto-light">God-Centered</span><span> Indigenous</span><span class="font-roboto-light"> Missions</span></h2></div><div class="after border"></div></div></div><!--end of row 3--><div id="mission" class="row"><div class="mission-wrapper"><div id="wrapper" class="col-sm-12 center content-bg"><h2 class="text-center font-roboto-bold page-title">ABOUT</h2><span class="format-options"><h3 data-bind="click:changeTwo, css:{ formatOptionsToggle: twoActive()}" class="text-center font-roboto" style="cursor:pointer">Info</h3><h3 data-bind="click:changeOne, css:{ formatOptionsToggle: oneActive()}" class="text-center font-roboto" style="cursor:pointer">Folks</h3></span><hr><div data-bind="if: twoActive,fadeVisible: twoActive" class="center info-wrapper"><p class="center-content"><span style="font-weight:bold">History: </span>Construction of Hope began in 2012 in Thailand with the desire to share God’s love with migrant construction workers from Cambodia. This desire developed into partnerships with indigenous churches in Thailand and Cambodia to provide education, discipleship, and holistic care for children and to support families through biblical teaching and sustainable business opportunities.</p><br><br><p class="center-content"><span style="font-weight:bold">Mission: </span>Empowered by Christ’s love, we partner with indigenous leaders in Thailand and Cambodia to share the Gospel, disciple, and develop sustainable opportunities for disadvantaged men, women, and children.</p><br><br><p class="center-content"><span style="font-weight:bold">Vision: </span>To continue in expanding current projects through additional facilities to accommodate more children in need, to see young leaders discipled and sent out from current projects to new areas, and to continuously support and build a network of indigenous leaders.</p></div><div data-bind="if: oneActive,fadeVisible: oneActive" class="center folks-wrapper"><div class="row"><div class="col-sm-6 folks"><img class="img-responsive" src="images/somnang.jpg"><h4>Sin Somnang <a href="mailto:somnangs@constructionofhope.org"><span class="glyphicon glyphicon-envelope"></span></a></h4><h5>Indigenous Pastor - Cambodia</h5></div><div class="col-sm-6"><p>Pastor Somnang Sin is the Senior Pastor of Fellowship Church of Pochentong. He has served in that capacity since 2003. Pastor Somnang has a Bachelor's Degree in Khmer Literature from the Royal University of Phnom Penh and a Master of Religious Education from Asia Biblical Theological Seminary of Cornerstone University. He was born and raised in Phnom Penh. He became a Christian in 1995 and God has placed a real burden on his heart for the poor, needy and uneducated in his community. He believes that educating his people, with a biblical foundation, is the key to rebuilding Cambodia. He has a wife, Lean Chanthy, and a son, Seng Josiah.</p></div></div><div class="row"><div class="col-sm-6 folks"><img class="img-responsive" src="images/vino.jpg"><h4>Jatupong (Vino) Srikhao <a href="mailto:vinoisblessed@gmail.com"><span class="glyphicon glyphicon-envelope"></span></a></h4><h5>Indigenous Pastor - Thailand</h5></div><div class="col-sm-6"><p>Pastor Vino became a Christian in 2005 and has been a pastor since 2012 when he planted what is now In Christ Church International. He has a vision and heart for the poor and migrant workers in Thailand. He believes in the guidance and power of the Holy Spirit in all aspects of his ministry. Pastor Vino also has a burden for Thai people who are living overseas. Pastor Vino and his wife, Vicky, live in Bangpli, just outside of Bangkok.</p></div></div><div class="row"><div class="col-sm-6 folks"><img class="img-responsive" src="images/jasong.jpg"><h4>Jason Glass <a href="mailto:jasong@constructionofhope.org"><span class="glyphicon glyphicon-envelope"></span></a></h4><h5>Country Director</h5></div><div class="col-sm-6"><p>Jason Glass was born and raised in North Carolina, graduated from Liberty University with a degree in education in 2008, and immediately began teaching in Bangkok, Thailand. With the vision of one day being part of starting a school, Jason completed a graduate program online through Liberty University and earned a Master’s degree in Educational Administration while teaching English at a small Thai school to grades kindergarten through grade six, before moving to International Community School to teach middle school Science. After teaching Science for four years, Jason is currently teaching middle school PE and Bible. While Jason’s desire for working overseas in missions stems from his childhood, his burden for migrant construction workers was formed after a prayer in the summer of 2012 for the Lord to give vision for his future led him to a construction site full of children near his home. Jason currently resides in Bangna, Bangkok with his wife, Christy, and daughter, Malia.</p></div></div><div class="row"><div class="col-sm-6 folks"><img class="img-responsive" src="images/tony.jpg"><h4>Tony Randall <a href="mailto:tonyr@constructionofhope.org"><span class="glyphicon glyphicon-envelope"></span></a></h4><h5>North American Liason</h5></div><div class="col-sm-6"><p>Tony Randall was born and raised on the west coast of the United States. He has an undergrad degree in Business Administration from Western Baptist College (Corban University) and a Master's in Teaching from Willamette University. Tony is an ordained minister through Commission Ministers Network. Education is a second career for Tony; he worked for a software development company prior to becoming a teacher. After teaching for 5 years in public schools, he was called into Christian education. That call brought he and his family (wife Angela and 2 kids Alathea and Azariah) to Bangkok, Thailand. Tony worked at International Community School as a high school math/computer teacher for four years. His family grew by one while living oversees, for his third child (Zechariah) was born in Bangkok. Tony has recently been called back to the US and is currently working as a 7th Grade Teacher at Native American Christian Academy in Arizona.</p></div></div><div class="row"><div class="col-sm-6 folks"><img class="img-responsive" src="images/jasons.jpg"><h4>Jason Son <a href="mailto:jasons@constructionofhope.org"><span class="glyphicon glyphicon-envelope"></span></a></h4><h5>Board Member</h5></div><div class="col-sm-6"><p>Jason Son fully committed his life to the Lord while attending the University of Calgary in Calgary, Alberta, Canada. He received a degree in Mathematics as well as one in Education and during the course of a few mission trips to Thailand, he felt the Lord prompting him to move there permanently. Jason has been working in Thailand since 2011, but in July of 2016 will be moving to Seoul, South Korea with his fiance, Joanne Benjathikul.</p></div></div></div></div><h2 class="text-center scripture"><span class="text">To loose the bonds of injustice...to let the oppressed go free<span><br><span class="isaiah">-Isaiah 58:6-</span></span></span></h2></div></div><!-- donate section --><div id="donate-section" class="row"><div class="col-sm-12 donate-wrap"><div class="donate-wrap"><a href="donate.php"><button type="button" class="btn btn-primary font-roboto-light btn-donate">DONATE</button></a></div></div></div><!--end of row 4--><div id="links" class="row"><div class="col-sm-12 bottompics"></div></div><!--end of row 5--><!--Inspiration and some markup for contact form modified from Light Up the Dark LLC Belton, MO--><div id="contact"><div class="contact-wrapper"><h3 class="text-left font-roboto-bold contact-format">Let's Connect</h3><!--Markup for Contact form--><form action="index.php" method="post" class="contact-format"><div class="form-group row"><div class="fields col-sm-4"><p><input type="text" class="form-control input-height" name="name" placeholder="Name" required></p><br><p><input type="email" class="form-control input-height" name="emailaddress" placeholder="Email" required></p><br></div><div class="col-sm-4 text-submit"><textarea class="center" cols="53" rows="10" name="message" placeholder="What's on your mind?"></textarea><p><input type="hidden" name="token" value="<?php echo $newToken; ?>"></p><p><button type="submit" name="submit" class="btn btn-primary button send">Send</button></p></div><div class="col-sm-4 phone-address"><!--               <h4>Email</h4>
            <p>
